...
@Component({
  selector: 'app-checkbox-demo5',
  templateUrl: './checkbox-demo5.component.html',
  styleUrls: ['./checkbox-demo5.component.scss'],
})
export class CheckboxDemo5Component {
  ...
  updateAllComplete(checkbox: any, checked: boolean) {
    ...
    const checkCompleted = this.checkboxList.filter((chBx) => chBx.completed).length;
